...
import (
	...
	//"time"
	//"strings"
	"github.com/Roshankumar/Demoproject/graph/model"
...
func FetchData(_ context.Context, input *model.StudentData) ([]*model.StudentOutput, error) {
...
//resultRow := &model.Studentoutput{}
if resultRow.BloodGroup == nil{
	a := ""
resultRow.BloodGroup = &a 
}

if resultRow.Dob == nil{
c :=""
resultRow.Dob = &c
}
// if resultRow.PhNo == nil{
// d := ""
// resultRow.PhNo = &d
// }
